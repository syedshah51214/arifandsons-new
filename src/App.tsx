...
function HomePage() {
  ...
  <div className={`md:hidden fixed inset-0 z-[120] transform transition-transform duration-300 ${mobileOpen ? 'translate-y-0 pointer-events-auto' : '-translate-y-full pointer-events-none'}`}>
